...
public class InChIGeneratorJNA  implements IInChIGeneratorImpl {
    ...
    public void generateInchiFromCDKAtomContainer(IAtomContainer atomContainer, 
        ...
        output = JnaInchi_toInchi(input, options);
    }
    ...
    public String getInchiKey() throws CDKException {
        InchiKeyOutput inchiKeyOutput = JnaInchi_inchiToInchiKey(getInchi());
    ...
    private InchiOutput JnaInchi_toInchi(InchiInput input, InchiOptions options) {
		return InchiAPI.toInchi(input, options);
	}

    private InchiKeyOutput JnaInchi_inchiToInchiKey(String inchi) {
