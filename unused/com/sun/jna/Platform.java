...
public final class Platform {
    ...
    public static final int WASM = 13;
	...
	static {
		String osName = (/** @j2sNative "wasm" || */
		System.getProperty("os.name"));

		if (osName.startsWith("wasm")) {
			osType = WASM;
		} else {
			/**
			 * @j2sNative
		...
		ARCH = (/** @j2sNative "wasm" ||*/ getCanonicalArchitecture(System.getProperty("os.arch"), osType));
