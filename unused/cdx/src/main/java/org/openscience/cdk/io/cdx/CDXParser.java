...
import org.openscience.cdk.io.cdx.CDXMLParser.CDBond;
import org.openscience.cdk.io.cdx.CDXMLParser.CDNode;
...
public class CDXParser extends XmlReader implements CDXMLParser.CDXReaderI {
	...
	public static IAtomContainer parseFile(String path) {
	...
	public boolean parse(IAtomContainer mol, String cdxml) {
		this.mol = mol;
	...
	public boolean parse(IAtomContainer mol, byte[] cdx) {
		return (get(mol, cdx) != null);
	}

	private IAtomContainer get(IAtomContainer mol, byte[] cdx) {
	...
	public int getBondOrder(String key) {
		...
		case "1":
		case "single":
			return IAtomContainer.cBondTypeSingle;
		case "2":
		case "double":
			return IAtomContainer.cBondTypeDouble;
		case "3":
		case "triple":
			return IAtomContainer.cBondTypeTriple;
		case "up":
			return IAtomContainer.cBondTypeUp;
		case "down":
			return IAtomContainer.cBondTypeDown;
		case "either":
			return BOND_ORDER_STEREO_EITHER;
		case "null":
			return BOND_ORDER_NULL;
		case "delocalized":
			return IAtomContainer.cBondTypeDelocalized;
		default:
		case "partial":
			return IAtomContainer.cBondTypeMetalLigand;
		}
	}
